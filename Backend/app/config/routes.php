...
$router->post('api/client/update', 'Clients@update', ['Auth@admin', 'Validation@id|firstname|lastname|age|profession']); //*🚀
$router->post('api/client/delete', 'Clients@delete', ['Auth@admin', 'Validation@id']); //*
...
$router->post('api/rdv/update', 'RDV@update', ['Auth@client', 'Validation@id|client_id|date|time_slot|description']); //*🚀
$router->post('api/rdv/delete', 'RDV@delete', ['Auth@client', 'Validation@id']); //*🚀